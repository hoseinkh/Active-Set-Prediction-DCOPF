...
#
num_of_total_samples_to_consider = 55276 # for 50% penetration
num_of_total_samples_to_consider = 98632 # for 40% penetration
#
...
num_of_top_classes_to_consider = 22   # avoid training on less populated classes (improve speed)
num_of_candidates_to_return = 2      # return multiple labels (improve accuracy)
