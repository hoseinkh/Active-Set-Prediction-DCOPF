...
#
#
num_of_top_classes_to_consider = 74
...
priors = [1/(len(list_of_accepted_classes)) for i in range(len(list_of_accepted_classes))]
lda = LDA(solver='lsqr', tol = 0.000001, priors=priors)
...
#
# # Train classifier
# lda.fit(X_train_trimmed_over, y_train_trimmed_over)
