...
%
% curr_dir = pwd;
curr_dir = '/Users/hkhazaei/PycharmProjects/Power_Sys_New/Matlab_codes';
%
%
...
%
% mpc.H_list_of_buses_to_add_noise_to_load = [2,11,24,37,43];
mpc.H_list_of_buses_to_add_noise_to_load = [1:mpc.H_num_of_nodes];
%
mpc.H_list_of_std_of_noise_of_loads = 3 * mpc.bus(mpc.H_list_of_buses_to_add_noise_to_load,3);
%
%
...
for i = 1:length(mpc.H_list_of_buses_to_add_noise_to_load)
    curr_node = mpc.H_list_of_buses_to_add_noise_to_load(i);
%     curr_matrix_of_noises = unifrnd( mpc.bus(curr_node,3) - mpc.H_list_of_std_of_noise_of_loads(curr_node) ,  mpc.bus(curr_node,3) + mpc.H_list_of_std_of_noise_of_loads(curr_node) ,  num_of_samples , 1);
    curr_matrix_of_noises = unifrnd( 0 - mpc.H_list_of_std_of_noise_of_loads(curr_node) ,  0 + mpc.H_list_of_std_of_noise_of_loads(curr_node) ,  num_of_samples , 1);
