...
% mpc.H_list_of_buses_to_add_noise_to_load = [1:mpc.H_num_of_nodes];
%
...
% mpc.H_std_of_noises_to_add_noise_to_load = mpc.H_list_of_std_of_noise_of_loads .* mpc.bus(mpc.H_list_of_buses_to_add_noise_to_load,3)';
...
result_cong_pattern_struct.matrix_of_power_output_of_generators = []; % will be filled later   
result_cong_pattern_struct.LMPs = []; % will be filled later   
%
...
for i = 1:1:num_of_samples
    ...
    if results.success == 0 % infeasible solution
        ...
        %
        result_cong_pattern_struct.matrix_of_power_output_of_generators = [result_cong_pattern_struct.matrix_of_power_output_of_generators;results.gen(:,2)'];
        result_cong_pattern_struct.LMPs = [result_cong_pattern_struct.LMPs;results.bus(:,14)'];
        %
...
if false
    ...
    matrix_of_power_output_of_generators_H = result_cong_pattern_struct.matrix_of_power_output_of_generators;
    ...
    matrix_of_LMPs_H = result_cong_pattern_struct.LMPs;
...
elseif true
    ...
    % save the matrix_of_congestions_of_samples___feasible
    matrix_of_congestions_of_samples___feasible_H = result_cong_pattern_struct.matrix_of_congestions_of_samples___feasible;
    writematrix( matrix_of_congestions_of_samples___feasible_H , 'matrix_of_congestions_patterns___feasible.csv');
    % save the label_of_feasible_samples___single_number_labeling
    label_of_feasible_samples___single_number_labeling_H = result_cong_pattern_struct.label_of_feasible_samples___single_number_labeling;
